...
class Authy
{
    private $api_key = "YOUR API KEY";          				//SET TO THE APPROPRIATE API KEY
    private $base_url = "http://sandbox-api.authy.com/protected/json/";    	//SET TO THE APPROPRIATE API URL
 ...
 **/
    function new_user($email,$cellphone,$country_code)
    {
        //build the url
		$curl = $this->base_url;
        $curl .= "users/new?api_key=".$this->api_key;
